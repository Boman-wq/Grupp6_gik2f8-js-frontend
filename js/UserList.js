...
function renderUser(user) {
    ...
    <li class="card card-catalina-blue text-dark">
        <a class="card-link card-link-catalina-blue" data-user="${user.id}" href="./update.html?id=${user.id}"><span title="Uppdatera ${user.f_name} ${user.l_name}">Uppdatera</span></a>
        <a class="card-link2 card-link-catalina-blue" data-user="${user.id}" href="./delete.html?id=${user.id}"><span title="Delete ${user.f_name} ${user.l_name}">Delete</span></a>
